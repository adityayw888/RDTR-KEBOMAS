...
map.getView().fit([12531179.596995, -805148.719477, 12543025.627995, -797617.432558], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Rencana Pola Ruang Kebomas</h2>';
        return titleElement;
    })(),
